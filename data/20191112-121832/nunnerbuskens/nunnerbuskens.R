...
manualAnalysis <- function() {
  ...
  ssData_b2_0.0 <- subset(ssData, ssData$nb.b2 == 0.0)
  plots_b2_0.0 <- getPlotRow(ssData = ssData_b2_0.0, xAxis = ssData_b2_0.0$nb.b1, xTitle = "b1")
  plots_b2_0.0[[1]]
  plots_b2_0.0[[2]]
  plots_b2_0.0[[3]]
  plots_b2_0.0[[4]]

  ssData_b2_0.0_b1_1.0 <- subset(ssData, ssData$nb.b2 == 0.0 & ssData$nb.b1 == 1.0 & ssData$net.pathlength.av > 1.0)
  mean(ssData_b2_0.0_b1_1.0$net.degree.av)
  mean(ssData_b2_0.0_b1_1.0$net.clustering.av)
  mean(ssData_b2_0.0_b1_1.0$net.pathlength.av)


  ssData_b2_0.8 <- subset(ssData, ssData$nb.b2 == 0.8)
  plots_b2_0.8 <- getPlotRow(ssData = ssData_b2_0.8, xAxis = ssData_b2_0.8$nb.b1, xTitle = "b1")
  plots_b2_0.8[[1]]
  plots_b2_0.8[[2]]
  plots_b2_0.8[[3]]
  plots_b2_0.8[[4]]

  ssData_b2_0.8_b1_1.8 <- subset(ssData, ssData$nb.b2 == 0.8 & ssData$nb.b1 == 1.08 & ssData$net.pathlength.av > 1.0)
  mean(ssData_b2_0.8_b1_1.8$net.degree.av)
  mean(ssData_b2_0.8_b1_1.8$net.clustering.av)
  mean(ssData_b2_0.8_b1_1.8$net.pathlength.av)

  hist(ssData_b2_0.0_b1_1.0$net.degree.av)
  hist(ssData_b2_0.8_b1_1.8$net.degree.av)
  hist(ssData_b2_0.0_b1_1.0$net.clustering.av)
  hist(ssData_b2_0.8_b1_1.8$net.clustering.av)
  hist(ssData_b2_0.0_b1_1.0$net.pathlength.av)
  hist(ssData_b2_0.8_b1_1.8$net.pathlength.av)

  # two-sided
  t.test(ssData_b2_0.0_b1_1.0$net.degree.av, ssData_b2_0.8_b1_1.8$net.degree.av)
  t.test(ssData_b2_0.0_b1_1.0$net.clustering.av, ssData_b2_0.8_b1_1.8$net.clustering.av)
  t.test(ssData_b2_0.0_b1_1.0$net.pathlength.av, ssData_b2_0.8_b1_1.8$net.pathlength.av)


  # b2 = 0.5
  ssData_b2_0.5 <- subset(ssData, ssData$nb.b2 == 0.5 & ssData$nb.phi >= 0.2)
  plots_b2_0.5 <- getPlotRow(ssData = ssData_b2_0.5, xAxis = ssData_b2_0.5$nb.alpha, xTitle = "alpha")
  # b2 = 1.0
  ssData_b2_1 <- subset(ssData, ssData$nb.b2 == 1.0 & ssData$nb.phi >= 0.2)
  plots_b2_1 <- getPlotRow(ssData = ssData_b2_1, xAxis = ssData_b2_1$nb.alpha, xTitle = "alpha")
  # b2 = 1.0
  ssData_b2_1.5 <- subset(ssData, ssData$nb.b2 == 1.5 & ssData$nb.phi >= 0.2)
  plots_b2_1.5 <- getPlotRow(ssData = ssData_b2_1.5, xAxis = ssData_b2_1.5$nb.alpha, xTitle = "alpha")
