...
manualAnalysis <- function() {
  ...
  ssData_b2_0.8_b1_1.08  <- subset(ssData, ssData$nb.b1 == 1.08  & ssData$net.pathlength.av > 1.0)
  mean(ssData_b2_0.8_b1_1.08$net.degree.av)
  mean(ssData_b2_0.8_b1_1.08$net.clustering.av)
  mean(ssData_b2_0.8_b1_1.08$net.pathlength.av)

  ssData_b2_0.8_b1_1.085 <- subset(ssData, ssData$nb.b1 == 1.085 & ssData$net.pathlength.av > 1.0)
  mean(ssData_b2_0.8_b1_1.085$net.degree.av)
  mean(ssData_b2_0.8_b1_1.085$net.clustering.av)
  mean(ssData_b2_0.8_b1_1.085$net.pathlength.av)

  ssData_b2_0.8_b1_1.09  <- subset(ssData, ssData$nb.b1 == 1.09  & ssData$net.pathlength.av > 1.0)
  mean(ssData_b2_0.8_b1_1.09$net.degree.av)
  mean(ssData_b2_0.8_b1_1.09$net.clustering.av)
  mean(ssData_b2_0.8_b1_1.09$net.pathlength.av)

  ssData_b2_0.8_b1_1.095 <- subset(ssData, ssData$nb.b1 == 1.095 & ssData$net.pathlength.av > 1.0)
  mean(ssData_b2_0.8_b1_1.095$net.degree.av)
  mean(ssData_b2_0.8_b1_1.095$net.clustering.av)
  mean(ssData_b2_0.8_b1_1.095$net.pathlength.av)
