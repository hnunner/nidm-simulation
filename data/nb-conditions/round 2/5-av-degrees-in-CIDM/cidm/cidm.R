...
manualAnalysis <- function() {
  ...
  ssData <- loadSimulationSummaryData()
  ssData <- subset(ssData, ssData$net.param.beta == 2 & ssData$dis.param.mu == 1.5)
  ssData <- subset(ssData, ssData$dis.param.s == 50.0 & ssData$net.param.r == 1.5)

  # similar average degree as RND
  ss.data.rnd <- subset(ssData, ssData$net.param.N == 34)
  mean(ss.data.rnd$net.prop.av.degree.pre.epidemic)
  sd(ss.data.rnd$net.prop.av.degree.pre.epidemic)
  mean(ss.data.rnd$net.prop.av.clustering.pre.epidemic)
  sd(ss.data.rnd$net.prop.av.clustering.pre.epidemic)
  mean(ss.data.rnd$dis.prop.pct.rec)
  sd(ss.data.rnd$dis.prop.pct.rec)
  mean(ss.data.rnd$dis.prop.duration)
  sd(ss.data.rnd$dis.prop.duration)

  # similar average degree as SWw
  ss.data.sw1 <- subset(ssData, ssData$net.param.N == 33)
  mean(ss.data.sw1$net.prop.av.degree.pre.epidemic)
  sd(ss.data.sw1$net.prop.av.degree.pre.epidemic)
  mean(ss.data.sw1$net.prop.av.clustering.pre.epidemic)
  sd(ss.data.sw1$net.prop.av.clustering.pre.epidemic)
  mean(ss.data.sw1$dis.prop.pct.rec)
  sd(ss.data.sw1$dis.prop.pct.rec)
  mean(ss.data.sw1$dis.prop.duration)
  sd(ss.data.sw1$dis.prop.duration)

  # similar average degree as SWs
  ss.data.sw2 <- subset(ssData, ssData$net.param.N == 30)
  mean(ss.data.sw2$net.prop.av.degree.pre.epidemic)
  sd(ss.data.sw2$net.prop.av.degree.pre.epidemic)
  mean(ss.data.sw2$net.prop.av.clustering.pre.epidemic)
  sd(ss.data.sw2$net.prop.av.clustering.pre.epidemic)
  mean(ss.data.sw2$dis.prop.pct.rec)
  sd(ss.data.sw2$dis.prop.pct.rec)
  mean(ss.data.sw2$dis.prop.duration)
  sd(ss.data.sw2$dis.prop.duration)
