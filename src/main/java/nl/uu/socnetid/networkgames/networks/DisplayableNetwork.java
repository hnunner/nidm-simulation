...
public class DisplayableNetwork extends Network {
    ...
    /* (non-Javadoc)
     * @see nl.uu.socnetid.networkgames.networks.Network#addActor(
     * nl.uu.socnetid.networkgames.utilities.UtilityFunction, nl.uu.socnetid.networkgames.diseases.DiseaseSpecs,
     * double)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see nl.uu.socnetid.networkgames.networks.Network#removeActor()
     */
    @Override
