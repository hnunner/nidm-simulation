package nl.uu.socnetid.netgame.diseases;

import nl.uu.socnetid.netgame.diseases.types.DiseaseState;
...
public class SIRDisease implements Disease {
    ...
    /* (non-Javadoc)
     * @see nl.uu.socnetid.netgame.diseases.Disease#evolve()
     */
    @Override
    public void evolve() {
        this.currDuration++;
    ...
    /* (non-Javadoc)
     * @see nl.uu.socnetid.netgame.diseases.Disease#getDiseaseSpecs()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see nl.uu.socnetid.netgame.diseases.Disease#isInfectious()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see nl.uu.socnetid.netgame.diseases.Disease#isDefeated()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see nl.uu.socnetid.netgame.diseases.Disease#getTimeRemaining()
     */
    @Override
