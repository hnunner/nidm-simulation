...
public enum NetworkAttributes {
    ...
    AV_DEGREE_VACCINATED("av.degree.vaccinated"),
    AV_DEGREE_VACCINATED_NOT("av.degree.vaccinated.not"),
    AV_DEGREE_QUARANTINED("av.degree.quarantined"),
    AV_DEGREE_QUARANTINED_NOT("av.degree.quarantined.not"),
