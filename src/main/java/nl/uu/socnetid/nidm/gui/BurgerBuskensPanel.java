 ...
 */
public class BurgerBuskensPanel extends DeactivatablePanel {

    private static final long serialVersionUID = -185698368265056724L;

    private DoubleJFormattedTextField txtB1;
    private DoubleJFormattedTextField txtB2;
    private DoubleJFormattedTextField txtC1;
    private DoubleJFormattedTextField txtC2;
    private DoubleJFormattedTextField txtC3;
    ...
    public BurgerBuskensPanel() {
        ...
        txtB1 = new DoubleJFormattedTextField(NUM_FORMAT);
        txtB1.setBounds(245, 28, 50, 20);
        add(txtB1);
        txtB1.setHorizontalAlignment(SwingConstants.RIGHT);
        txtB1.setColumns(10);
        txtB1.setValue(new Double(1));
        txtB1.setInputVerifier(REAL_NUMBERS_VERIFIER);
        ...
        txtB2 = new DoubleJFormattedTextField(NUM_FORMAT);
        txtB2.setBounds(245, 53, 50, 20);
        add(txtB2);
        txtB2.setHorizontalAlignment(SwingConstants.RIGHT);
        txtB2.setColumns(10);
        txtB2.setValue(new Double(0));
        txtB2.setInputVerifier(REAL_NUMBERS_VERIFIER);
        ...
        txtC1 = new DoubleJFormattedTextField(NUM_FORMAT);
        txtC1.setBounds(245, 123, 50, 20);
        add(txtC1);
        txtC1.setHorizontalAlignment(SwingConstants.RIGHT);
        txtC1.setColumns(10);
        txtC1.setValue(new Double(0.2));
        txtC1.setInputVerifier(REAL_NUMBERS_VERIFIER);

        JLabel lblC21 = new JLabel("Quadratic");
        lblC21.setBounds(36, 150, 154, 16);
        add(lblC21);

        JLabel lblC22 = new JLabel("(c  ):");
        lblC22.setHorizontalAlignment(SwingConstants.RIGHT);
        lblC22.setBounds(200, 150, 35, 16);
        add(lblC22);

        txtC2 = new DoubleJFormattedTextField(NUM_FORMAT);
        txtC2.setBounds(245, 148, 50, 20);
        add(txtC2);
        txtC2.setHorizontalAlignment(SwingConstants.RIGHT);
        txtC2.setColumns(10);
        txtC2.setValue(new Double(0.1));
        txtC2.setInputVerifier(REAL_NUMBERS_VERIFIER);

        JLabel lblC31 = new JLabel("Triadic closure");
        lblC31.setBounds(36, 175, 100, 16);
        add(lblC31);

        JLabel lblC32 = new JLabel("(c  ):");
        lblC32.setHorizontalAlignment(SwingConstants.RIGHT);
        lblC32.setBounds(200, 175, 35, 16);
        add(lblC32);

        txtC3 = new DoubleJFormattedTextField(NUM_FORMAT);
        txtC3.setBounds(245, 173, 50, 20);
        add(txtC3);
        txtC3.setHorizontalAlignment(SwingConstants.RIGHT);
        txtC3.setColumns(10);
        txtC3.setValue(new Double(0.2));
        txtC3.setInputVerifier(REAL_NUMBERS_VERIFIER);
    ...
    public void enableComponents() {
        this.txtB1.setEnabled(true);
        this.txtB2.setEnabled(true);
    ...
    public void diseableComponents() {
        this.txtB1.setEnabled(false);
        this.txtB2.setEnabled(false);
