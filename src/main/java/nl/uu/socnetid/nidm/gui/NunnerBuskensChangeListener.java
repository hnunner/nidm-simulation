 ...
 */
public interface NunnerBuskensChangeListener {

    /**
     * Entry point for changes in b1 (Nunner & Buskens, 2019).
     */
    void notifyB1Changed();
    /**
     * Entry point for changes in c1 (Nunner & Buskens, 2019).
     */
    void notifyC1Changed();

    /**
     * Entry point for changes in c2 (Nunner & Buskens, 2019).
     */
    void notifyC2Changed();

    /**
     * Entry point for changes in b2 (Nunner & Buskens, 2019).
     */
