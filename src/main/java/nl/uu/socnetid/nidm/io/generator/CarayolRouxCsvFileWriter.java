 ...
 */
public abstract class CarayolRouxCsvFileWriter extends CsvFileWriter {

    protected CarayolRouxDataGeneratorData crData;
     ...
     */
    public CarayolRouxCsvFileWriter(String fileName, CarayolRouxDataGeneratorData crData) throws IOException {
        super(fileName);
        this.crData = crData;
        initCols();
    }
