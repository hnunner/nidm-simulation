...
public class NunnerBuskensParameters extends UtilityModelParameters {
    ...
    // disease costs
    private boolean dRandom;
    private double dRandomMin;
    private double dRandomMax;
    private double[] ds;
	...
	public boolean isDRandom() {
		return dRandom;
	}

	public void setDRandom(boolean dRandom) {
		this.dRandom = dRandom;
	}

	public double getDRandomMin() {
		return dRandomMin;
	}

	public void setDRandomMin(double dRandomMin) {
		this.dRandomMin = dRandomMin;
	}

	public double getDRandomMax() {
		return dRandomMax;
	}

	public void setDRandomMax(double dRandomMax) {
		this.dRandomMax = dRandomMax;
	}
	...
	public double getCurrD() {
		return currD;
	}

	public void setCurrD(double currD) {
		this.currD = currD;
	}
