 ...
 */
public class ProfessionNetworkGeneticParameters extends UtilityModelParameters {
    ...
    // current offspring
    private ProfessionsGene offspring;

    // lockdown base network file
    private String lockdownNetworkBaseFile;
     ...
     */
    public ProfessionsGene getOffspring() {
        return offspring;
    }
     ...
     */
    public void setOffspring(ProfessionsGene offspring) {
    ...
    /**
     * @return the lockdownNetworkBaseFile
     */
    public String getLockdownNetworkBaseFile() {
        return lockdownNetworkBaseFile;
    }

    /**
     * @param lockdownNetworkBaseFile the lockdownNetworkBaseFile to set
     */
    public void setLockdownNetworkBaseFile(String lockdownNetworkBaseFile) {
        this.lockdownNetworkBaseFile = lockdownNetworkBaseFile;
    }
