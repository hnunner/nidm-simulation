...
public enum LogValues {
    ...
    IV_NB_B2("nb.b2"),
    IV_NB_D1_RANDOM("nb.d1.random"),
    IV_NB_D1_RANDOM_MIN("nb.d1.random.min"),
    IV_NB_D1_RANDOM_MAX("nb.d1.random.max"),
    IV_NB_D1("nb.d1"),
    IV_NB_D2_RANDOM("nb.d2.random"),
    IV_NB_D2_RANDOM_MIN("nb.d2.random.min"),
    IV_NB_D2_RANDOM_MAX("nb.d2.random.max"),
    IV_NB_D2("nb.d2"),
    ...
    IV_NB_SELECTIVE_RANDOM("nb.selective.random"),
    IV_NB_SELECTIVE("nb.selective"),
    IV_NB_ZETA("nb.zeta"),
    ...
    IV_NB_GEN_CLUSTERING_TARGET("nb.gen.clustering.target"),
    IV_NB_GEN_CLUSTERING_DANON("nb.gen.clustering.danon"),
    ...
    IV_NB_PROF_LOCKDOWN_CONDITION("nb.prof.lockdown.condition"),
    IV_NB_PROF_LOCKDOWN_NETWORK_BASE_FILE("nb.prof.lockdown.network.base.file"),
    ...
    DV_NB_PROF_DEGREE_BELOT("nb.prof.degree.belot."),
    DV_NB_PROF_DEGREE_TARGET("nb.prof.degree.target."),
    ...
    DV_NB_PROF_DEGREE_SD_BELOT("nb.prof.degree.sd.belot."),
    DV_NB_PROF_DEGREE_SD_TARGET("nb.prof.degree.sd.target."),
    ...
    IV_NB_PROF_VACCINE_AVAILIBILITY("nb.prof.vaccine.availibility"),
    IV_NB_PROF_VACCINE_DISTRIBUTION("nb.prof.vaccine.distribution"),
    IV_NB_PROF_VACCINE_SHOTS_GIVEN("nb.prof.vaccine.shots.given"),
    IV_NB_PROF_VACCINE_AGENTS_IMMUNIZED("nb.prof.agents.immunized"),
    IV_NB_PROF_GROUPS_RECEIVED_SHOTS("nb.prof.groups.received.shots"),
    ...
    DV_NET_GEN_FITNESS_DEGREE("net.gen.fitness.degree."),
