...
public enum LogValues {
    ...
    DV_AGENT_ASSORTATIVITY("agent.assortativity"),
    ...
    DV_INDEX_ASSORTATIVITY("index.assortativity"),
    ...
    DV_NET_STATIC_ASSORTATIVITY_CONDITION("net.static.assortativity.condition"),
    DV_NET_STATIC_ASSORTATIVITY_POST("net.static.assortativity.post"),
    ...
    DV_NET_DYNAMIC_ASSORTATIVITY_CONDITION("net.dynamic.assortativity.condition"),
    DV_NET_DYNAMIC_ASSORTATIVITY_POST("net.dynamic.assortativity.post"),
