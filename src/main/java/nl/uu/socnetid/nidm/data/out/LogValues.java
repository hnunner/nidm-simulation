...
public enum LogValues {
    ...
    DV_NET_N_VACCINATED("net.n.vaccinated"),
    DV_NET_N_QUARANTINED("net.n.quarantined"),
    DV_NET_AV_DEGREE_VACCINATED("net.degree.av.vaccinated"),
    DV_NET_AV_DEGREE_QUARANTINED("net.degree.av.quarantined"),
    DV_NET_AV_DEGREE_VACCINATED_NOT("net.degree.av.vaccinated.not"),
    DV_NET_AV_DEGREE_QUARANTINED_NOT("net.degree.av.quarantined.not"),
