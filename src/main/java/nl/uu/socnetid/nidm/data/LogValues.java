...
public enum LogValues {
    ...
    DV_NET_ASSORTATIVITY_RSIGMA("net.assortativity.rsigma"),
    DV_NET_ASSORTATIVITY_RSIGMA_PRE("net.assortativity.rsigma.pre.epidemic"),
    DV_NET_ASSORTATIVITY_RSIGMA_POST("net.assortativity.rsigma.post.epidemic"),
    DV_NET_ASSORTATIVITY_RPI("net.assortativity.rpi"),
    DV_NET_ASSORTATIVITY_RPI_PRE("net.assortativity.rpi.pre.epidemic"),
    DV_NET_ASSORTATIVITY_RPI_POST("net.assortativity.rpi.post.epidemic"),
