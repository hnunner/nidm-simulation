 ...
 */
public class BurgerBuskensTest {
    ...
    public void initAgent() {
        this.network = new Network("BurgerBuskens Test");
    ...
    public void testGetUtility() {
        assertEquals(2.0, Precision.round(this.agent1.getUtility().getOverallUtility(), 1), 0);
        assertEquals(1.9, Precision.round(this.agent4.getUtility().getOverallUtility(), 1), 0);
        assertEquals(1.8, Precision.round(this.agent8.getUtility().getOverallUtility(), 1), 0);
    }
